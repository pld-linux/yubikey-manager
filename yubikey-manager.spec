...
BuildRequires:	python3-cryptography < 49
BuildRequires:	python3-fido2 >= 2.0
...
BuildRequires:	python3-makefun < 2
BuildRequires:	python3-pskc >= 1.3
BuildRequires:	python3-pskc < 2
